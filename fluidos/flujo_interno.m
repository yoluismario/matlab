...
%% Problema 70
% Circuito de distribución de kerosene, tubería de dos ramas.
% Debemos considerar que en una tubería en paralelo las pérdidas de carga
% son idénticas en todas las ramas, mientras que se dividen los caudales.
