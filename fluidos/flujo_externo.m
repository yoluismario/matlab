...
D_transversal = q*CD_transversal*a^2

Re_orient = V*a*rho_aire/mu_aire

CD_orient = CD2(Re_orient)
D_orient = q*CD_orient*2*a^2
Comparacion = D_transversal/D_orient*100
